...
\
📌 **Overview**\
This project applies data science workflows to evaluate customer behavior for a simulated Nigerian e-commerce platform. By engineering RFM (Recency, Frequency, Monetary) scores from 100,000+ raw transaction records, this analysis profiles high-value shoppers and runs simulated A/B tests to measure campaign effectiveness.\
\
